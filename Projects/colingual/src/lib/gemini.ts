 ...
 * Configure `VITE_AI_ASSISTANT_ENDPOINT` so your server forwards to Gemini with the same model id.
 * Gemini provider keys must stay on the server because VITE_ values are public client configuration.
 */

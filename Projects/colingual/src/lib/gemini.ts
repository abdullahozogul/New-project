 ...
 * Configure `VITE_AI_ASSISTANT_ENDPOINT` (your server forwards to Gemini with the same model id).
 * In local development, Vite's `/api/gemini/generate` proxy uses server-only `AI_ASSISTANT_API_KEY`.
 */

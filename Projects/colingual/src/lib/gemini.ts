 ...
 * Configure `VITE_AI_ASSISTANT_ENDPOINT` in production, or use the Vite dev proxy with
 * `AI_ASSISTANT_API_KEY` locally. Provider keys must stay out of browser bundles.
 */

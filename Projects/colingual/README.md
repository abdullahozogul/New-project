...
# Browser code calls your backend endpoint; local dev uses /api/gemini/generate.
VITE_AI_ASSISTANT_ENDPOINT=
# Optional override of model id (default: gemini-2.5-flash)
VITE_GEMINI_MODEL=
# Browser code calls your backend TTS endpoint; local dev uses /api/tts/synthesize.
VITE_TTS_ENDPOINT=

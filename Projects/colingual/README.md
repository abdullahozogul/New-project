...
Only variables prefixed with `VITE_` are exposed to browser code. Call Gemini from a server or edge function and point `VITE_AI_ASSISTANT_ENDPOINT` at it; keep provider API keys out of the client bundle.

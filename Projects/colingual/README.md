...
Only variables prefixed with `VITE_` are exposed to browser code. Keep Gemini, ElevenLabs, and OpenAI keys server-only (`AI_ASSISTANT_API_KEY`, `ELEVENLABS_API_KEY`, `OPENAI_API_KEY`) and point the app at backend endpoints in production.
